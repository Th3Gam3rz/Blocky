    ...
    <body>
        <nav>
            <div class="nav-wrapper <?php echo getThemeColour()['nav']; ?>">
              ...
              <ul class="side-nav" id="mobile-nav">
                ...
                <li class="active"><a href="/store.php"><i class="fa fa-credit-card"></i> Store</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 l8">
                        <div class="card <?php echo getThemeColour()['store:server']; ?>">
                            <div class="card-content">
                                <span class="card-title <?php echo getThemeColour()['store:server:text']; ?>" id="store-link">
                                    Store
                                </span>
                                <div class="row">
                                    <span id="packages">
        ...
        <script>
            function updateStats() {
                $('#packages').html($.ajax({
                    type: "POST",
                    url: "/php/get-store-packages.php",
                    async: false
                }).responseText);
                $('#store-link').html($.ajax({
                    type: "POST",
                    url: "/php/store-link.php",
                    async: false
                }).responseText);
                $('#motd').html($.ajax({
                    type: "POST",
